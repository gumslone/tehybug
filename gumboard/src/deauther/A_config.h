...
#elif defined(DSTIKE_DEAUTHER_OLED_V2) ||                                      \
    defined(DSTIKE_DEAUTHER_OLED_V2_5) || defined(DSTIKE_DEAUTHER_OLED_V3)
...
#elif defined(DSTIKE_DEAUTHER_OLED_V3_5) ||                                    \
    defined(DSTIKE_DEAUTHER_OLED_V4) || defined(DSTIKE_DEAUTHER_OLED_V5) ||    \
    defined(DSTIKE_DEAUTHER_MOSTER) || defined(DSTIKE_DEAUTHER_MOSTER_V2) ||   \
    defined(DSTIKE_DEAUTHER_MOSTER_V3) || defined(DSTIKE_DEAUTHER_MOSTER_V4)
...
#elif defined(DEFAULT_ESP8266) || defined(NODEMCU) ||                          \
    defined(WEMOS_D1_MINI) || defined(DSTIKE_USB_DEAUTHER) ||                  \
    defined(DSTIKE_NODEMCU_07) || defined(DSTIKE_DEAUTHER_V1) ||               \
    defined(DSTIKE_DEAUTHER_V2) || defined(DSTIKE_DEAUTHER_V3)
// ===== LED ===== //
#define LED_DIGITAL
...
#define LED_PIN_B 2  // ESP-12 LED
          ...
          defined(WEMOS_D1_MINI) || defined(DSTIKE_USB_DEAUTHER) ||            \
          defined(DSTIKE_NODEMCU_07) || defined(DSTIKE_DEAUTHER) ||            \
          defined(DSTIKE_DEAUTHER_V1) || defined(DSTIKE_DEAUTHER_V2) ||        \
          defined(DSTIKE_DEAUTHER_V3) */
// ============================== //
...
#if !defined(LED_DIGITAL) && !defined(LED_RGB) && !defined(LED_NEOPIXEL) &&    \
    !defined(LED_MY92) && !defined(LED_DOTSTAR)
#define LED_DIGITAL
#define USE_LED false
#else // if !defined(LED_DIGITAL) && !defined(LED_RGB) && !defined(LED_NEOPIXEL)
      // && !defined(LED_MY92) && !defined(LED_DOTSTAR)
#define USE_LED true
#endif // if !defined(LED_DIGITAL) && !defined(LED_RGB) &&
       // !defined(LED_NEOPIXEL) && !defined(LED_MY92) && !defined(LED_DOTSTAR)
...
#if !defined(SSD1306_I2C) && !defined(SSD1306_SPI) && !defined(SH1106_I2C) &&  \
    !defined(SH1106_SPI)
#define SSD1306_I2C
#define USE_DISPLAY false
#else /* if !defined(SSD1306_I2C) && !defined(SSD1306_SPI) &&                  \
         !defined(SH1106_I2C) && !defined(SH1106_SPI) */
#define USE_DISPLAY true
#endif /* if !defined(SSD1306_I2C) && !defined(SSD1306_SPI) &&                 \
          !defined(SH1106_I2C) && !defined(SH1106_SPI) */
...
#endif // if BUTTON_UP != 0 && BUTTON_DOWN != 0 && BUTTON_A != 0 && BUTTON_B !=
       // 0
