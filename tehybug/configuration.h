...
void saveConfig() {
  ...
  if (shouldSaveConfig) {
    ...
    json["configModeActive"] = device.configMode;
    json["sleepModeActive"] = device.sleepMode;
...
void setConfigParameters(JsonObject &json) {
  ...
  if (json.containsKey("configModeActive")) {
    device.configMode = json["configModeActive"].as<bool>();
  }
  ...
  if (json.containsKey("sleepModeActive")) {
    device.sleepMode = json["sleepModeActive"].as<bool>();
  }
